...
import M1.Interface
import M1.Interface (CtlSig(cpu), SysIO (io_DMA), CtlState (st_load2, st_loadxi3, st_cmp, st_loadxi1))
...
-- Generate control signals
      ...
      ctl_ad_ld   = orw [st_load0,st_load1,st_loadxi0,st_loadxi1,st_lea0,st_lea1,st_store0, -- loadxi added
                         ...
                         st_jal0,st_jal1]
      ctl_ad_alu  = orw [st_load1,st_loadxi1,st_store1,st_jump1,st_jumpc01,st_jumpc11,st_jal1]
